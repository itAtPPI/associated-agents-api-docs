...
!!! note ""
    ...
    Accede a la documentación de swagger sandbox a traves de este [__link__](https://clientapi_sandbox.portfoliopersonal.com/swagger/index.html).

__Postman Collection__
!!! note ""

    Accede a la collección de postman a traves de este [__link__](https://www.postman.com/portfoliopersonal/workspace/associated-agents-api-ppi). Para poder usar nuestra colección de Postman deberás crear una bifurcación o "Fork".
